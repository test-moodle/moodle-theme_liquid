...
$string['faqanswerdesc'] = 'This content will be displayed as answer.';
$string['faqdescription'] = 'FAQ section description';
$string['faqdescriptiondesc'] = 'This is a text displayed bellow FAQ section title.';
$string['faqnumber'] = 'Question {$a->faq}';
$string['faqquestion'] = 'Question';
$string['faqquestiondesc'] = 'This will be text for a question.';
$string['faqtitle'] = 'FAQ section title';
$string['faqtitledesc'] = 'This is a title of the FAQ section.';
$string['fontfamily'] = 'Font family';
$string['fontfamily_desc'] = 'Enter a CSS value of font-family you want to use in this field.';
$string['frontpagefaq'] = 'Frontpage FAQ';
...
$string['instagramlink'] = 'Instagram link';
$string['leftnavigation'] = 'Display navigation on left';
$string['linkedinlink'] = 'Linkedin link';
$string['navigationtitle'] = 'Navigation';
$string['numberfaq'] = 'Number of questions/answers';
$string['numberfaqdesc'] = 'Select a number of questions/answers you want to display.';
...
$string['showfaq'] = 'Show/hide FAQ';
$string['showfaqdesc'] = 'Checkbox should be checked to display FAQ on frontpage.';
...
$string['socialiconstitle'] = 'Social icons';
...
$string['xlink'] = 'X link';
$string['youtubelink'] = 'Youtube link';
